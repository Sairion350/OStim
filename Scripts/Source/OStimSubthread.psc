ScriptName OStimSubthread extends BaseObject
import outils 
...
Function GetClothesFromMain()
	...
	if ostim.TossClothesOntoGround
		...
		domclothes = oundress.DomEquipmentForms.data
		subclothes = oundress.SubEquipmentForms.data
		thirdclothes = oundress.ThirdEquipmentForms.data
	endif 
...
OStimSubthread Function NewObject(int threadID) Global
	OStimSubthread obj = BaseObject.Construct("OStimSubthread") as OStimSubthread
